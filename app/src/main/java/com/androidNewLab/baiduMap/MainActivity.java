...
public class MainActivity extends AppCompatActivity {
    ...
    public void queryHistoryTrack() {
        ...
        client.queryHistoryTrack(MainActivity.serviceId, entityName, simpleReturn, startTime, endTime, pageSize, pageIndex, trackListener);
    }
    /**
     * 显示历史轨迹
     *
    ...
    public void drawHistoryTrack(final List<LatLng> points) {
        ...
        if (points == null || points.size() == 0) {
            Looper.prepare();
            Toast.makeText(MainActivity.this, "当前查询无轨迹点", Toast.LENGTH_SHORT).show();

            Looper.loop();
            resetMarker();
        } else if (points.size() >= 1) {
            Toast.makeText(MainActivity.this, "当前查询有轨迹点", Toast.LENGTH_SHORT).show();
